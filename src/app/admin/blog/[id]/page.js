        ...
        <form method="POST">
          ...
          <div className="my-1 grid grid-cols-1">
            {loading ? (
              ...
              <button
                onClick={(e) => editData(e, id)}
                className="w-full mt-5 text-lg border-2 text-white rounded-lg bg-sky-500 px-5 py-2 font-semibold"
              >
                {" "}
                UPDATE BLOG
              </button>
          ...
          <div className="my-1 grid grid-cols-1">
            <button
              ...
              className="w-full mt-5 text-lg border-2 text-white rounded-lg bg-red-500 px-5 py-2 font-semibold"
            >
              {" "}
              DELETE BLOG
            </button>
